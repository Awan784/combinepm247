...
<head>
  ...
  <title>Contract Signed - PM247</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border: 1px solid #dddddd; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 20px; text-align: left;">
              <h2 style="color: #11224d; margin-bottom: 10px;">Hello {{$contract->job->engineer_user->name ?? ""}},</h2>
              <p style="color: #333333; font-size: 16px; line-height: 1.6;">
                The contract has been signed for the Job at <strong>{{$contract->job->postcode}}</strong>. Please only proceed when payment has also been confirmed as paid. You will be informed once payment is received by email and sms.
              </p>
