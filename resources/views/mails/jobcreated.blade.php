...
<p>A request has been made for contracts and payments to be sent for the following details.</p>
...
<head>
  ...
  <title>Contract and Payment Request Made - PM247</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border: 1px solid #dddddd; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 20px; text-align: left;">
              <h2 style="color: #11224d; margin-bottom: 10px;">Dear PM247 Team,</h2>
              <p style="color: #333333; font-size: 16px; line-height: 1.6;">
                A request has been made for contracts and payments to be sent for the following details.
              </p>
              <p style="color: #333333; font-size: 16px; line-height: 1.6;">
                <strong>Request Made By:</strong> “{{$job->added_by_user_name()}}”<br>
                <strong>Job Creation Time:</strong> “{{$job->created_at}}”<br>
                <strong>Customer Email:</strong> “{{$job->customer_email}}”<br>
                <strong>Postcode:</strong> “{{$job->postcode}}”<br>
                <strong>Job Invoice Number:</strong> “{{$job->job_invoice_no}}”
              </p>
              <h4 style="color: #11224d; margin-bottom: 10px;">Kind Regards,</h4>
              <p style="color: #333333; font-size: 16px; line-height: 1.6;">
                Agent Assigned Team
              </p>
            </td>
