...
<head>
  ...
  <title>Password Changed - PM247</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border: 1px solid #dddddd; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 20px; text-align: left;">
              <h2 style="color: #11224d; margin-bottom: 10px;">{{$data["name"]}}</h2>
              <p style="color: #333333; font-size: 16px; line-height: 1.6;">Your password has been changed</p>
                <p style="color: #333333; font-size: 16px; line-height: 1.6;">Your new password is</p>
              ...
              <p style="color: #333333; font-size: 16px; line-height: 1.6;">
                You may login using this url {{url('/')}}
              </p>
            </td>
          </tr>
