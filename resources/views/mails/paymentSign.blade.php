...
<head>
  ...
  <title>Payment Received - PM247</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border: 1px solid #dddddd; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 20px; text-align: left;">
              <h2 style="color: #11224d; margin-bottom: 10px;">Hello {{$payment->job->engineer_user->name ?? ""}},</h2>
              <p style="color: #333333; font-size: 16px; line-height: 1.6;">
                The Payment has been received for the Job at <strong>{{$payment->job->postcode}}</strong>. Please only proceed when the contract has also been confirmed as received. You will be informed once the contract is received by email and sms.
              </p>
              <h4 style="color: #11224d; margin-bottom: 10px;">Kind Regards</h4>
              <p style="color: #333333; font-size: 16px; line-height: 1.6;">
                Contracts & Payments Team
              </p>
            </td>
          </tr>
